...
#if defined(NEW_STRUCT)

#define unit_test_setup_teardown_id(test, setup, teardown, id, opt)	\
	{ #test, test, setup, teardown, UNIT_TEST_FUNCTION_TYPE_TEST, id, opt }

#define unit_test_setup_teardown(test, setup, teardown)	\
    unit_test_setup_teardown_id(test, setup, teardown, 0, NULL)

#define unit_test_id(f, id, opt) unit_test_setup_teardown_id(f, default_setup, default_teardown, id, opt)
#define unit_test(f)  unit_test_id(f, 0, NULL)

#else
// Initializes a UnitTest structure.
#define unit_test(f) { #f, f, default_setup, default_teardown, UNIT_TEST_FUNCTION_TYPE_TEST, 0, NULL }
#define unit_test_setup(test, setup) \
	{ #test "_" #setup, setup, default_setup, default_teardown, UNIT_TEST_FUNCTION_TYPE_SETUP, 0, NULL }
#define unit_test_teardown(test, teardown) \
	{ #test "_" #teardown, teardown, default_setup, default_teardown, UNIT_TEST_FUNCTION_TYPE_TEARDOWN, 0, NULL }
...
#define unit_test_setup_id(test, setup, id, opt) \
	{ #test "_" #setup, setup, default_setup, default_teardown, UNIT_TEST_FUNCTION_TYPE_SETUP, id, opt }
#define unit_test_id(f, id, opt) { #f, f, default_setup, default_teardown, UNIT_TEST_FUNCTION_TYPE_TEST, id, opt }
#define unit_test_teardown_id(test, teardown, id, opt) \
	{ #test "_" #teardown, teardown, default_setup, default_teardown, UNIT_TEST_FUNCTION_TYPE_TEARDOWN, id, opt }


#define unit_test_setup_teardown_id(test, setup, teardown, id, opt)	\
	unit_test_setup_id(test, setup, id, opt), \
	unit_test_id(test, id, opt), \
	unit_test_teardown_id(test, teardown, id, opt)
#endif
...
#define run_tests_setup_teardown_id(tests, setup, teardown, id) \
    _run_tests_setup_teardown_id(tests, sizeof(tests) / sizeof(tests)[0], setup, teardown, id)
#define run_tests_id(tests, id) \
    run_tests_setup_teardown_id(tests, default_setup, default_teardown, id)
#define run_tests(tests) \
    run_tests_id(tests, 0)

#else
#define run_tests(tests) _run_tests(tests, sizeof(tests) / sizeof(tests)[0], 0)
#define run_tests_id(tests, id) _run_tests(tests, sizeof(tests) / sizeof(tests)[0], id)
#endif
// Dynamic allocators
